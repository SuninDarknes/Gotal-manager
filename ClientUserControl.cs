...
namespace Gotal_manager
{
    public partial class ClientUserControl : UserControl
    {
        ...
        public ClientUserControl(int _id = 0, string _naziv = null, string _adresa = null, string _telefon = null, string _email = null, string _VAT = null)
        {
            InitializeComponent();
            modified = false;
            this.id = _id;
        ...
        {
            DialogResult result = MessageBox.Show("Jesi li siguran da želiš obrisati ovog kupca?", "Brisanje", MessageBoxButtons.YesNo, MessageBoxIcon.Warning);
